defmodule Backends.ConsolePutsBackend do
  @moduledoc """
  ConsolePutsBackend implements a GenEvent handler for the elixir Logger.

  It mimics everything the core :console backend does, but uses IO.puts to
  log the messages instead of io_async.
  """
  ...
  def handle_event({level, _gl, {Logger, msg, ts, md}}, state) do
    IO.puts(:stdio, format_event(level, msg, ts, md, state))
    {:ok, state}
  end
